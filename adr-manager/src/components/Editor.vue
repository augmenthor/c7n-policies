    ...
    <v-card class="d-flex flex-column">
        <v-card-text class="px-0 py-0 my-0" style="position: relative; height: 100%">
            <v-tabs-items v-model="tab" style="position: absolute; height: 100%; width: 100%">
                ...
                <!--end 'Raw Editor'-->
                <v-tab-item data-cy="versionHistory" :value="'Version History'" style="height: 100%">
                    <EditorVersionHistory style="height: 100%" />
                </v-tab-item>
                <!--end 'Version History'-->
            </v-tabs-items>
        </v-card-text>
...
import EditorVersionHistory from "./EditorVersionHistory.vue";
...
export default {
    ...
    data: () => ({
        ...
        tab: "MADR Editor",
        tabs: ["MADR Editor", "Markdown Preview", "Raw Markdown", "Version History"],
