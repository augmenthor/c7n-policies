...
export class Repository {
    constructor({ fullName, activeBranch, branches, adrs, adrPath, manifest }) {
        ...
        // Immutability manifest for this repository (see plugins/manifest.js).
        // May be undefined until the repository content is loaded.
